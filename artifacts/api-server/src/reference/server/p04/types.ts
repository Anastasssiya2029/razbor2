...
export const P04_OUTPUT_SCHEMA_VERSION = "1.3" as const;
...
export type P04ClientChecklistState =
  | "missing"
  | "partial"
  | "undocumented"
  | "unmeasured"
...
export type P04ClientChecklistItem = {
  task_id: string;
  state: P04ClientChecklistState;
  client_task: string;
  client_done_when: string;
  source_refs: string[];
};

export type P04ClientRoutePresentation = {
  items: P04ClientChecklistItem[];
};
...
export type P04ResultV1_2 = {
  ...
  routeCards: Array<P04RouteCardIdentity & {
    ...
    source_refs: string[];
    client_presentation: P04ClientRoutePresentation;
  }>;
  businessValidation: {
