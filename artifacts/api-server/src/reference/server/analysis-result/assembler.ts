...
function assertFrozenVersions(source: AnalysisResultSource): void {
  ...
  if (p04.promptVersion !== "P-04.v1.3" || p04.outputSchemaVersion !== "1.3") {
    fail("ANALYSIS_RESULT_P04_VERSION_UNSUPPORTED", "Final assembly requires P-04.v1.3/schema 1.3.", "version_conflict");
  }
