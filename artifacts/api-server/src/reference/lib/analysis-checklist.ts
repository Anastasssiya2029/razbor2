...
//
// This MUST stay identical to the copy in artifacts/cabinet/src/lib/analysis-checklist.ts
// -- the frontend builds the initial canonical checklist from the same
// AnalysisResultV1 and this function must derive the exact same task ids, or
// the manager-plan save endpoint rejects legitimate edits as "source
// mismatch" / "canonical tasks removed" purely from client/server disagreeing
// on ids for the same immutable result.
