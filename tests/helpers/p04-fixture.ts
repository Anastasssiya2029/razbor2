...
function p02Result(): P02ResultV1_3 {
  return {
    ...
    candidateAudit: [{
      element_id: "audience",
      hypothesis: "Качество входящих разговоров ограничивает переход к оплате.",
      supporting_evidence_ids: ["E05", "E06"],
      counterevidence_ids: [],
      dependency_position: "До продуктового предложения",
      target_necessity: "Для целевой модели требуется подтверждённый сегмент.",
      decision: "selected",
      rejection_reason: null,
      tie_break_step: null,
    }],
    bundle: {
      priority_element: "audience",
      build_elements: [],
      maintain_elements: ["authenticity", "product_method", "sales_technology", "funnel", "blog", "team"],
      later_elements: [],
      why_this_bundle: "Сначала проверяется качество целевого разговора до расширения маршрута.",
      why_not_now: [],
    },
    elementSequence: [{
      order: 1,
      ...
      from_score: 2,
      to_score: 5,
      why_now: "Сегмент нужен до изменения предложения и увеличения потока.",
      prerequisite_elements: [],
      unlocks: ["Наблюдаемый переход от целевого разговора к решению"],
      evidence_ids: ["E05", "E06"],
    }],
