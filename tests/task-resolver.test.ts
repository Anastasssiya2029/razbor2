...
async function sourceWith(sequence = [milestone(1, "product_method", 3, 5)]): Promise<TaskResolverSource> {
  ...
  const storedP02: StoredP02Result = {
    ...
    ruleVersions: { requestBuilder: "p02-request-builder.v2.1", elements: "elements.v1", levelCapabilities: "scoring-rules.v3.2", constraintRules: "constraint-rules.v2.1", dependencyRules: "dependency-rules.v2.1", targetRules: "target-rules.v2.2", transitionLevers: "transition-levers.v2" },
    inputHash: "p02-input",
    strategyContext,
    targetConfig,
    result,
