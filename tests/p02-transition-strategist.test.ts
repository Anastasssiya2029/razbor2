...
function p01(scores = SCORES): P01ResultV1_3 {
  ...
  return {
    promptVersion: "P-01.v1.3", schemaVersion: "1.3", analysisStatus: "ok", evidenceLedger: ledger, current7k,
    businessMap: {
    ...
    moneyNowSignals: [], moneyNowHistory: history,
...
function stage4Source(result = p01()): Stage4Source {
  return { analysisRunId: "run-1", diagnosticId: "diag-1", runStatus: "targeting", normalizedInput: diagnostic(), p01AnalysisResultId: "p01-1", p01PromptVersion: "P-01.v1.3", p01OutputSchemaVersion: "1.3", p01InputHash: "p01-input", p01Result: result, p01FailureCode: null, p01FailureMessage: null };
}
...
function upstream(result = p01()): P02UpstreamSource {
  ...
  return { analysisRunId: "run-1", diagnosticId: "diag-1", runStatus: "strategizing", p01AnalysisResultId: "p01-1", p01PromptVersion: "P-01.v1.3", p01OutputSchemaVersion: "1.3", p01InputHash: "p01-input", p01Result: result, p01FailureCode: null, targetStage };
}
