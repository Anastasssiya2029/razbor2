    ...
    properties: {
      ...
      growthLink: {
        ...
        properties: {
          ...
          supporting: { type: "array", minItems: 1, maxItems: 3, items: { $ref: "#/$defs/elementRecommendation" } },
        },
      },
      doNotDo: {
        type: "array",
  ...
  growthLink: {
    ...
    supporting: [
      ...
      },
      {
        ...
        minimumChange:
          "Двухдневная работа с Соулой: опыт, суперсилы, ценность, собственный способ помощи, право на цену, короткая самопрезентация.",
